...
typealias AddTripScreen = TripSearchView
...
struct TripSearchView: View {
    ...
    // MARK: - Bannière scan billet

    var scanTicketBanner: some View {
            ...
            HStack(spacing: 14) {
                ZStack {
                    ...
                    Image(systemName: "ticket.fill")
                        ...
                        .foregroundStyle(
                            LinearGradient(
                                colors: [Color.majorelleBlue, .white],
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Photo du billet → infos remplies automatiquement")
                        .font(.rsCaption)
        ...
        .sheet(isPresented: $showScanner) {
            TicketScannerView(isPresented: $showScanner) { ticket in
                viewModel.applyScannedTicket(ticket)
            }
